        ...
        <div className="glass px-4 md:px-6 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            {currentUser ? <>
              ...
              {(currentUser.role==="admin"||currentUser.role==="superadmin") && <button onClick={()=>setPage("admin")} className="inline-flex items-center gap-1.5 px-4 py-2 rounded-lg bg-gradient-to-r from-cyan-500/30 to-purple-500/30 border border-cyan-400/50 text-cyan-200 font-medium text-sm shadow-[0_0_20px_rgba(34,211,238,.2)]" data-cursor="hover"><LayoutDashboard className="w-4 h-4"/>Dashboard</button>}
              <div className="relative">
